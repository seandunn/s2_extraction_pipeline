define(['lib/file_handling/tecan', 'mapper/s2_root'], function(tecanHandler, root) {
  'use strict';
  ...
  return function() {      
    describe("Tecan Files", function(){
      ...
      beforeEach(function(done){
          ...
          var sourceList = [];
          $.when.apply(this, _.map(['../test/data/gwl/127073.gwl', '../test/data/gwl/127073.json', '../test/data/gwl/layout_test.gwl'], function(path) {
      ...
      it("can do a new layout from a list of sources and a destination", function(done) {
          var destination = {number_of_rows:12, number_of_columns: 8, labels: { barcode: { value: '12345'}}, tubes: {}};
          var userName = "TEST_USER_1";
          root.load({user:userName}).done(function(results) { 
              results.findByLabEan13('3960299138815').done(function(source) {
