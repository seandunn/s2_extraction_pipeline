define(['workflow_engine', 'mapper/s2_ajax'], function (workflowEngine, S2Ajax) {
  ...
  app.prototype.init = function () {
    this.currentPagePresenter = this.workflow.get_default_presenter(this).init("#content").update();
  }
  ...
  app.prototype.childDone = function (page_presenter, action, data) {
    ...
    this.currentPagePresenter = this.workflow.get_next_presenter(this).init("#tube1").update(data);
  }
